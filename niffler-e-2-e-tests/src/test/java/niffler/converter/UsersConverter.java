...
public class UsersConverter implements ArgumentConverter {
    private ClassLoader cl = this.getClass().getClassLoader();
    private ObjectMapper om = new ObjectMapper();

    @Override
    public ResponseUsers convert(Object source, ParameterContext context) throws ArgumentConversionException {
        ...
        try (InputStream is = cl.getResourceAsStream((String) source);
            ...
            return om.readValue(isr, ResponseUsers.class);
        } catch (IOException e) {
